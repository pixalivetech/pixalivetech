    ...
    <footer className="bg-black text-white px-6 md:px-16 pt-20 pb-16 md:pb-40 relative overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div className="flex flex-col gap-5">
          <img src={Logo} alt="Pixla Logo" className="h-8 w-8" />

          <p className="textmd leading-relaxed max-w-xs">
            From bold ideas to real-world tech—<br />
            Pixla is where innovation comes alive.
          </p>

          <a
            href="mailto:contact@Pixlatech.com"
            className="text-sm inline-flex items-center gap-1 hover:underline"
          >
            contact@Pixlatech.com <FaArrowUpRightFromSquare size={10} />
          </a>
        ...
        <div className="flex flex-col gap-2 text-sm">
          <a
            href="https://www.linkedin.com/company/Pixla-technology-network/?viewAsMember=true"
            target="_blank"
          ...
          <a
            href="https://www.instagram.com/Pixlatech/?next=%2F"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1 hover:underline"
          >
      ...
      <div className="max-w-7xl mx-auto mt-12 flex flex-col mb-12 md:mb-20 md:flex-row justify-between items-start md:items-center gap-4 text-xs text-gray-400">
        <p>© 2025 Pixla Technology Services. <br />All rights reserved.</p>
