...
export default function WhyChoosePixla() {
  return (
    <section className=" p-4 w-full max-w-[1280px] mx-auto text-black sm:px-6 md:px-10 py-12 sm:py-16">
      <div className="flex flex-col lg:flex-row justify-between items-start gap-10">
        <div className="lg:w-1/3">
          <h2 className="text-lg font-lufga tracking-wide">Why Choose Pixla Commerce</h2>
        </div>
        <div className="lg:w-2/3 space-y-6">
          <h1 className="text-3xl md:text-5xl font-lufga leading-[130%]">
            Pixla Commerce is a next-gen eCommerce platform designed for growth-driven businesses.
          </h1>
          <div className="grid grid-cols-1 text-lg md:grid-cols-2 md:mt-20 mt-4 md:gap-50 gap:6">
            ...
            <p className='md:mt-0 mt-8'>
              With deep expertise in commerce technology and part of the Pixla Ecosystem, we help you simplify operations and maximize reach — all from a single, unified system.
            </p>
          </div>
        </div>
      </div>
